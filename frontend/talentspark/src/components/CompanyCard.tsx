...
function CompanyCard({
    companies, jobs, onAdd, onEdit, onDelete
}: Props) {
    const [editCompanyId, setEditCompanyId] = useState<number | null>(null);
    const [addform, setAddform] = useState<CompanyPayload>({
        name: "",
        email: "",
        phone: "",
        location: "",
    });
    const [editform, setEditform] = useState<CompanyPayload>({
        name: "",
        email: "",
        phone: "",
        location: "",
                    ...
                    <div key={company.id} className="card">
                        ...
                        <>
                            ...
                            <div className="action-buttons">
                                ...
                                >Edit</button>
                                <button onClick={() => company.id && onDelete(company.id)}>Delete</button>
                            </div>
                        </>}
                    </div>
                ))}
